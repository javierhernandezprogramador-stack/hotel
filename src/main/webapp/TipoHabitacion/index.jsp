                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-md-flex align-items-center">
                                <div>
                                    <h4 class="card-title">Tabla Tipo de Habitaciones</h4>
                                </div>
                                <div class="ms-auto mt-3 mt-md-0">
                                    ...
                                    <div class="componente-registrar">
                                        <a type="button" class="btn btn-primary m-1 btn-header-r"
                                           href="${pageContext.request.contextPath}/TipoHabitacion/formulario.jsp">Nuevo</a>
                                    </div>
                            ...
                            <div class="table-responsive mt-4">
                                <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                                    ...
                                    <c:forEach var="t" items="${tipoHabitaciones}">
                                        <tr>
                                            <td class="px-0">
                                            ...
                                            <td class="px-0">
                                                <c:choose>
                                                    ...
                                                    <c:when test="${t.estado == 0}">
                                                        <span class="badge bg-info">Deshabilitada</span>
                                                    </c:when>
                                                </c:choose>
                                            </td>
                                            <td class="px-0 text-dark fw-medium text-end">
                                                <form action="${pageContext.request.contextPath}/tipoHabitacion"
                                                      method="post">
                                                ...
                                                <form action="${pageContext.request.contextPath}/tipoHabitacion"
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${t.estado == 1}">
                                                            ...
                                                            <button type="submit" class="btn btn-danger m-1 w-85">Deshabilitar</button>
                                                        </c:when>

                                                        <c:when test="${t.estado == 0}">
                                                             <input type="hidden" name="estado" value="1">
                                                             <button type="submit" class="btn btn-success m-1 w-85">Habilitar</button>
                                                        </c:when>
                                                    </c:choose>
                                                </form>
