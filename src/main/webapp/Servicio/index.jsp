                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-md-flex align-items-center">
                                <div>
                                    <h4 class="card-title">Tabla de Servicios</h4>
                                </div>
                            ...
                            <div class="table-responsive mt-4">
                                <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-0 text-muted">Precio</th>
                                    ...
                                    <c:forEach var="s" items="${servicios}">
                                        <tr>
                                            ...
                                            <td class="px-0">${s.nombre}</td>
                                            <td class="px-0">$ ${s.precio}</td>
                                            <td class="px-0">${s.descripcion}</td>
                                            <td class="px-0">${s.tipoServicio.nombre}</td>
                                            <td class="px-0">
                                                <c:choose>
                                                    <c:when test="${s.estado == 1}">
                                                        <span class="badge bg-info">Habilitada</span>
                                                    </c:when>
                                                    <c:when test="${s.estado == 0}">
                                                        <span class="badge bg-info">Deshabilitada</span>
                                                    </c:when>
                                                </c:choose>
                                            </td>
                                            <td class="px-0 text-dark fw-medium text-end">
                                                <form action="${pageContext.request.contextPath}/servicio"
                                                      method="post">
