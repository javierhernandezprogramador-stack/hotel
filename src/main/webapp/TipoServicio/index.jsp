                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-md-flex align-items-center">
                                <div>
                                    <h4 class="card-title">Tabla Tipo de Servicios</h4>
                                </div>
                                <div class="ms-auto mt-3 mt-md-0">
                                    ...
                                    <div class="componente-registrar">
                                        <a type="button" class="btn btn-primary m-1 btn-header-r"
                                           href="${pageContext.request.contextPath}/TipoServicio/formulario.jsp">Nuevo</a>
                                    </div>
                            ...
                            <div class="table-responsive mt-4">
                                <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                                    ...
                                    <c:forEach var="t" items="${tipoServicios}">
                                        <tr>
                                            <td class="px-0">
                                            ...
                                            <td class="px-0 text-dark fw-medium text-end">
                                                <form action="${pageContext.request.contextPath}/tipoServicio"
                                                      method="post">
