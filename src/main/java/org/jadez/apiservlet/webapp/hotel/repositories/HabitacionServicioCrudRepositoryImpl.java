...
@Repository
public class HabitacionServicioCrudRepositoryImpl implements crudRepositoryHabitacionServicio {
    private Connection conn;

    @Inject
    public HabitacionServicioCrudRepositoryImpl(@MysqlConn Connection conn) {
        this.conn = conn;
    }
